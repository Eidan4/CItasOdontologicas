...
insert into Pacientes(pa_nombre,pa_apellido,idgenero,pa_direccion,pa_ciudad,idestadocivil,pa_paisorigen,idrh,pa_correo,pa_telefonocelular,pa_telefonooficiona,pa_cedula,idtipoidentidad,pa_fechanacimiento,password) 
